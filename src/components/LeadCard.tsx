...
const statusStyles: Record<Lead["status"], string> = {
  ...
  Pending: "bg-foreground/5 text-muted-foreground border-foreground/10",
};
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-navy to-secondary border border-foreground/10 font-display text-lg text-gold">
      ...
      <div className="mt-5 flex flex-wrap gap-2 text-[11px]">
        <span className="px-2.5 py-1 rounded-md bg-foreground/5 border border-foreground/10 text-muted-foreground">
      ...
      <Link
        ...
        className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-gold to-gold-soft px-4 py-2.5 text-sm font-medium text-white shadow-[var(--shadow-gold)] hover:brightness-110 transition-all"
      >
        Analyze Call
